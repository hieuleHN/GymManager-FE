  ...
  const fetchData = async (p = page) => {
    try {
      const res = await fetch(
        `${getApiUrl()}/api/salary/details?page=${p}&limit=15`,
                ...
                {staffList.map((staff, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm text-green-600 font-semibold">
                      {staff.bonus.toLocaleString("vi-VN")}đ
                    </td>
                    <td className="px-6 py-4 text-sm text-slate-900 font-semibold">
                      {staff.baseSalary.toLocaleString("vi-VN")}đ
                    </td>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex gap-2">
                        ...
                        <Button
                          variant="contained"
                          onClick={() => handlePaySalary(staff._id)}
                          disabled={staff.isPaid}
                          sx={{
                            bgcolor: staff.isPaid ? "#10b981" : "#4f46e5",
                            "&:hover": {
                              bgcolor: staff.isPaid ? "#059669" : "#4338ca",
                            },
                            textTransform: "none",
                            borderRadius: 2,
                            px: 2,
            ...
            <div className="space-y-4 mb-6">
              ...
              <div>
                ...
                <p className="text-lg font-bold text-indigo-600">
                  {selectedStaff.baseSalary.toLocaleString("vi-VN")}đ
                </p>
              </div>
              <div>
                ...
                <input
                  ...
                  onBlur={handleBlur}
                  className={`w-full p-3 border ${errors.newSalary ? "border-red-400" : "border-slate-200"} rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500`}
