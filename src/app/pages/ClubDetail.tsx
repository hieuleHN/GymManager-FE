...
export function ClubDetail() {
  ...
  const testimonials = [
    { name: 'Minh Tuấn', text: 'Cơ sở vật chất tuyệt vời, HLV nhiệt tình hỗ trợ 24/7.' },
    { name: 'Hoàng Oanh', text: 'Mình đã giảm 5kg sau 2 tháng nhờ lộ trình của PT tại đây.' },
    { name: 'Đức Phát', text: 'Không gian tập rộng rãi, máy móc hiện đại và đầy đủ.' }
  ];
