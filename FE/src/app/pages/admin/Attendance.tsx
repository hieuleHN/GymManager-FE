...
const attendanceRecords = [
  { id: 1, member: 'Nguyễn Văn A', checkIn: '08:30', date: '2024-05-26', phone: '0901234567', package: 'PREMIUM - Gym', timeRemaining: '45 ngày' },
  { id: 2, member: 'Trần Thị B', checkIn: '09:15', date: '2024-05-26', phone: '0912345678', package: 'STANDARD - Yoga', timeRemaining: '30 ngày' },
  { id: 3, member: 'Lê Văn C', checkIn: '10:00', date: '2024-05-26', phone: '0923456789', package: 'VIP - Boxing', timeRemaining: '60 ngày' },
  { id: 4, member: 'Phạm Thị D', checkIn: '14:00', date: '2024-05-26', phone: '0934567890', package: 'PREMIUM - Gym', timeRemaining: '15 ngày' },
  { id: 5, member: 'Hoàng Văn E', checkIn: '16:20', date: '2024-05-26', phone: '0945678901', package: 'STANDARD - Pilates', timeRemaining: '22 ngày' }
];
  ...
  return (
    <AdminLayout>
      <div className="max-w-7xl mx-auto space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-slate-900 mb-2">Quản lý điểm danh</h1>
          <p className="text-slate-600">Theo dõi lịch sử check-in của hội viên</p>
        </div>
